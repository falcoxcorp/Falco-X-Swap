    ...
    if (this.state.hasError) {
      return (
        <div className="p-4 bg-red-900/20 border border-red-800 rounded-lg text-red-300">
          ...
          <p className="text-sm mb-4">We're sorry, but there was an error loading this component.</p>
          <button
          ...
          {this.state.error && (
            <pre className="mt-4 p-2 bg-red-900/30 rounded text-xs overflow-auto">
