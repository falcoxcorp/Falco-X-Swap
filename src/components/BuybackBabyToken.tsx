...
const BuybackBabyToken: React.FC = () => {
  ...
  const [liquidityFee, setLiquidityFee] = useState('1');
    ...
    <div className="p-4 sm:p-6">
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-xl sm:text-2xl font-bold text-white">Buyback Baby Token</h1>
          <span className="px-2 py-1 bg-blue-500/20 text-blue-400 rounded text-xs">Coming Soon</span>
        </div>
        <p className="text-sm sm:text-base text-gray-400">Create a buyback baby token with reward mechanisms</p>
      </div>
      ...
      <div className="bg-gray-900/30 backdrop-blur-md rounded-lg border border-gray-800 p-6">
        <div className="space-y-6">
          ...
          {/* Liquidity Fee and Buyback Fee */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm text-gray-400 mb-2">Liquidity Fee (%) *</label>
              <input
                type="text"
                value={liquidityFee}
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-2">Buyback Fee (%) *</label>
              <input
                type="text"
                value={buybackFee}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm text-gray-400 mb-2">Reflection Fee (%) *</label>
              <input
                type="text"
                value={reflectionFee}
